...
public class Ambihue extends PApplet {
...
public String curl(String json, String url, String type)
{
  String output = "";
  String[] commands;
...
public String[] convertToColor(int r, int g, int b, int i) {
...
public int[] getAvarageValues(BufferedImage screenshot, int x, int y, int lampid, int lampCount) {
  int skipValue = 20;
...
//
public long[] RGBtoHSB(int r, int g, int b, long[] hsbvals) {
...
class P5Properties extends Properties {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Ambihue" };
    if (passedArgs != null) {
